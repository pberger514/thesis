...
%\vspace{-.1in}
\begin{center}
\includegraphics[width=1.0\textwidth]{figures/hol_other/ns_beam_profile_0-4_v2_errors.png}
...
%\vspace{-.1in}
\begin{center}
\includegraphics[width=1.0\textwidth]{figures/hol_other/ns_beam_profile_4-8_v2_errors.png}
